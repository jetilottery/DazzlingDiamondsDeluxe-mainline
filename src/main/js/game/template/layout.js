define({
  ...
  winUpTo: {
    ...
    landscape: { x: 327, y: 250 },
    portrait: { x: 405, y: 290 },
  },
  winUpToContainer: {
    type: 'container',
  ...
  winningNumbers: {
    ...
    landscape: { x: 16, y: 292 },
    portrait: { x: 106, y: 340 },
  },
  winningNumbersTitle: {
    type: 'text',
    string: 'luckyNumbers',
  ...
  bonusCardContainer: {
    ...
    landscape: { x: 328, y: 594 },
    portrait: { x: 405, y: 613 },
  },
  bonusBack: {
    type: 'sprite',
    anchor: 0.5, 
  ...
  bonusPrizeTable: {
    ...
    landscape: { scale: 0.75, x: 75, y: 150 },
  ...
  prizeLevel6: {
    ...
    landscape: { x: 300, y: 127 },
    portrait: { x: 245, y: 138 },
  },
  prizeLevel5: {
    type: 'container',
    children: ['bonusPrize5Win','bonusPrize5NoWin'],
    landscape: { x: 300, y: 219 },
    portrait: { x: 245, y: 230 },
  },
  prizeLevel4: {
    type: 'container',
    children: ['bonusPrize4Win','bonusPrize4NoWin'],
    landscape: { x: 300, y: 303 },
    portrait: { x: 245, y: 314 },
  },
  prizeLevel3: {
    type: 'container',
    children: ['bonusPrize3Win','bonusPrize3NoWin'],
    landscape: { x: 300, y: 379 },
    portrait: { x: 245, y: 390 },
  },
  prizeLevel2: {
    type: 'container',
    children: ['bonusPrize2Win','bonusPrize2NoWin'],
    landscape: { x: 300, y: 433 },
    portrait: { x: 245, y: 444 },
  },
  prizeLevel1: {
    type: 'container',
    children: ['bonusPrize1Win','bonusPrize1NoWin'],
    landscape: { x: 300, y: 468 },
    portrait: { x: 245, y: 479 },
  },
  ...
  bonusLives: {
    ...
    landscape: { x: 163, y: 526 },
    portrait: { x: 469, y: 361 },
  },
  bonusLivesLabel: {
    type: 'text',
    ...
    anchor: 0.5,
    maxWidth: 320,
    landscape: { x: 138, y: 35 },
    portrait: { x: 112, y: 15 },
  },
  bonusLife1: {
    type: 'container',
    landscape: { x: 25, y: 55, scale: 0.813 },
    portrait: { x: 0, y: 42, scale: 0.813 },
  },
  bonusLife2: {
    type: 'container',
    landscape: { x: 113, y: 55, scale: 0.813 },
    portrait: { x: 88, y: 42, scale: 0.813 },
  },
  bonusLife3: {
    type: 'container',
    landscape: { x: 201, y: 55, scale: 0.813 },
    portrait: { x: 176, y: 42, scale: 0.813 }
  },
  bonusPickPoints: {
    type: 'container',
    children: [
  ...
  bonusPickPoint2: {
    type: 'container',
    landscape: { x: 178, y: 25 },
    portrait: { x: 178, y: 25 },
  },
  bonusPickPoint3: {
    type: 'container',
    landscape: { x: 356, y: 25 },
    portrait: { x: 356, y: 25 },
  },
  bonusPickPoint4: {
    type: 'container',
    landscape: { x: 534, y: 25 },
    portrait: { x: 534, y: 25 },
  },
  bonusPickPoint5: {
    type: 'container',
  ...
  bonusPickPoint6: {
    type: 'container',
    landscape: { x: 178, y: 204 },
    portrait: { x: 178, y: 204 },
  },
  bonusPickPoint7: {
    type: 'container',
    landscape: { x: 356, y: 204 },
    portrait: { x: 356, y: 204 },
  },
  bonusPickPoint8: {
    type: 'container',
    landscape: { x: 534, y: 204 },
    portrait: { x: 534, y: 204 },
  },
  bonusPickPoint9: {
    type: 'container',
    landscape: { x: 0, y: 381 },
  ...
  bonusPickPoint10: {
    type: 'container',
    landscape: { x: 178, y: 381 },
    portrait: { x: 178, y: 381 },
  },
  bonusPickPoint11: {
    type: 'container',
    landscape: { x: 356, y: 381 },
    portrait: { x: 356, y: 381 },
  },
  bonusPickPoint12: {
    type: 'container',
    landscape: { x: 534, y: 381 },
    portrait: { x: 534, y: 381 },
  },
  ...
  winAllBG: {
    type: 'sprite',
    anchor: 0.5,
    landscape: { texture: 'landscape_winAllMessageBackground' },
    portrait: { texture: 'portrait_winAllMessageBackground' },
  },
  winAllMessage: {
    type: 'text',
    string: 'winAll',
  ...
  howToPlayPage1: {
    ...
    portrait: { x: 405, y: 664, wordWrapWidth: 560 },
  },
  howToPlayPage2: {
    type: 'text',
    string: 'page2',
  ...
  */
  ...
  autoPlayButton_default: {
    type: 'point',
    landscape: { x: 720, y: 712 },
    portrait: { x: 405, y: 1297 }, 
  },
  autoPlayButton_multi: {
    type: 'point',
    landscape: { x: 918, y: 712 },
    portrait: { x: 405, y: 1297 }, 
  },
  ...
  howToPlayTitle: {
    ...
    anchor: 0.5,    
    landscape: { x: 720, y: 178 },
    portrait: { x: 405, y: 292 },
  },
  versionText: {
    type: 'text',
    style: 'versionText',
  ...
  losePlaqueMessage: {
    ...
    anchor: 0.5,
    portrait: { maxWidth: 746 },
    landscape: { maxWidth: 746 },
  },
